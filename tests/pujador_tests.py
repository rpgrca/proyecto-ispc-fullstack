...
class ServicioPujadorTests(unittest.TestCase):
    def test_graba_usuario_de_tipo_pujador(self):
        ...
        PujadorController(db, C.NOMBRE_USUARIO, C.APELLIDO_USUARIO, C.OTRO_EMAIL_USUARIO, C.NOMBRE_USUARIO, C.CLAVE_USUARIO,
